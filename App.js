  ...
  return(
    ...
    <div className="h-100 w-full flex items-center justify-center bg-teal-lightest font-sans mt-20">
      ...
      <div className="bg-white rounded shadow p-6 m-4 w-full lg:w-3/4 lg:max-w-lg">
        ...
        <h1 className="text-3xl md:text-4xl text-indigo-600 font-medium mb-2"> My To-Do List</h1>
        ...
        <div className="flex mt-4">
          ...
          <button
            ...
            className="p-2 border border-orange-600 rounded text-white bg-indigo-600 transition-colors duration-300 mt-1 md:mt-0 md:mx-2"
        ...
        <div id="listBox">
          ...
          {todos.map((todo) => (
            ...
            <div className="flex mb-4 items-center" key={todo.id}>
              ...
              <button className="flex-no-shrink p-2 ml-2 border-2 rounded text-white bg-yellow-500" onClick={() => toggleCompleted(todo.id)}>{todo.completed? "Undone" : "Done"}</button>
              
              <button className="flex-no-shrink p-2 ml-2 border-2 rounded text-white bg-purple-500" onClick={() => moveTodoDown(todo.id)}>Down</button>
